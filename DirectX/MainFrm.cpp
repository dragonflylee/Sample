...
LRESULT CMaimFrm::OnCreate(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
    ...
    uTimer = SetTimer(uTimer, 100, NULL);
exit:
    // 返回 -1 表示窗口创建失败
...
LRESULT CMaimFrm::OnTimer(UINT /*uMsg*/, WPARAM wParam, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
...
LRESULT CMaimFrm::OnPaint(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& bHandled)
{
    bHandled = FALSE;
    return OnRender();
}
